    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <AppButton variant="outline"><BarChart3 size={16} className="mr-1"/> Generate Report</AppButton>
        </div>
      </div>
                ...
                <div key={batch.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 flex gap-3">
                      <button className="flex-1 bg-gray-50 text-gray-700 py-2 rounded-lg font-medium text-sm hover:bg-gray-100 transition border border-gray-200">View Roster</button>
                      <button className="flex-1 bg-brand-50 text-brand-700 py-2 rounded-lg font-medium text-sm hover:bg-brand-100 transition">View Analytics</button>
                    </div>
                  </div>
                </div>
              ))
